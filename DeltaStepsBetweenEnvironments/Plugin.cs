...
namespace Carfup.XTBPlugins.DeltaStepsBetweenEnvironments
{
	[Export(typeof(IXrmToolBoxPlugin)),
	   ExportMetadata("Name", "Delta Plugin Steps between two environments"),
	   ExportMetadata("Description", "Find out if there is differences about your plugin steps between two of your environments"),
	...
	public class Plugin : PluginBase
	{
		...
		{
			return new DeltaStepsBetweenEnvironments();
		}
	}
}
